int printer(int p1_printer_number,int p1_printer_symbol,int p2_printer_number,int p2_printer_symbol,int p3_printer_number,int p3_printer_symbol,
            int p4_printer_number,int p4_printer_symbol,int start_symbol, int start_number, int *player1_symbols , int *player1_numbers , int first_teams_score , int second_teams_score){
    ...
    printf("\tTeam 1: %d", first_teams_score);
    printf("\n");
    ...
    printf("\tTeam 2: %d", second_teams_score);
    printf("\n\t\t\t\t\tP1\n");
    printf("\t    ");
    for(int i=1;i<=56;i++){
        printf("-");
