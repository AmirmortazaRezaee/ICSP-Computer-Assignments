...
int main(){
  ...
  /*variables declaration*/
    ...
    int starter=1; /*a variable to determines the player who should start each round*/
    ...
    printer(p1_printer_number, p1_printer_symbol, p2_printer_number, p2_printer_symbol, p3_printer_number, p3_printer_symbol, p4_printer_number, p4_printer_symbol,start_symbol, start_number,player1_symbols, player1_numbers , first_teams_score, second_teams_score);
    ...
    int bakhshnameh_decimal=bakhshnameh;
        ...
        switch (starter){
            case 1: /*the condition in which, the first player (user) should start the game*/
                ...
                printer(p1_printer_number, p1_printer_symbol, p2_printer_number, p2_printer_symbol, p3_printer_number, p3_printer_symbol,
                 p4_printer_number, p4_printer_symbol,start_symbol, start_number,player1_symbols, player1_numbers , first_teams_score, second_teams_score);
